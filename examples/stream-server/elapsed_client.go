...
import (
	...
	"github.com/allons-y/openapi/examples/stream-server/client"
	"github.com/allons-y/openapi/examples/stream-server/client/operations"
	"github.com/allons-y/openapi/examples/stream-server/models"
)
