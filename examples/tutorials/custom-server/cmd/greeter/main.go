...
import (
	...
	"github.com/allons-y/openapi/examples/tutorials/custom-server/gen/restapi"
	"github.com/allons-y/openapi/examples/tutorials/custom-server/gen/restapi/operations"
)
