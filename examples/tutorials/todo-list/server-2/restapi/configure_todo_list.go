...
import (
	...
	"github.com/allons-y/openapi/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/allons-y/openapi/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
