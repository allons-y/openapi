...
import (
	...
	"github.com/allons-y/openapi/examples/tutorials/todo-list/server-complete/models"
	"github.com/allons-y/openapi/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/allons-y/openapi/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
